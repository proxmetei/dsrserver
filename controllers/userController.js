const { User, Animal, Document, Doctor, Session } = require('../models/models');
...
class UserController {
    ...
    async setSession(req, res, next) {
        const { animalId, DocId, date } = req.body;
        let createdSession = await Session.create({ animalId: animalId, doctorId: DocId, date: date });
